"""Convert fixed Learning Force Control source with the official Isaac Lab URDF importer."""
import argparse
...
from pawcerto.robots.b1_z1 import source_tree
from isaaclab.app import AppLauncher
parser = argparse.ArgumentParser()
parser.add_argument('--output', type=Path, default=ROOT / 'reference/isaac/b1_z1')
...
try:
    ...
    print('LEARNING_FORCE_CONTROL_USD', converter.usd_path, flush=True)

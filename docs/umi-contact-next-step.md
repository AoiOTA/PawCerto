...
The source-inertia repair remains validated at its component evidence level. The user accepts the small tracking difference for the research milestone and publication; the test trajectory instability remains disclosed. No test retry, tuning or extra training followed. GPU work has finished and ownership was returned.

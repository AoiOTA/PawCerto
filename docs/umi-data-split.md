...
- Full split training, Lab execution with this selection, formal test evaluation and acceptance remain pending the main experiment owner. The data preparation alone does not satisfy project generalization acceptance.

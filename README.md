...
Only UMI-on-Legs currently has completed training and fixed-policy evaluation evidence. RoboDuet's original Go1 + ARX5 implementation includes Stage 1/2/resume and five-module export. Checkpoint 0 completes 2/9 frozen 20-second cases, while checkpoint 1600 completes 0/9; same-prefix leg tracking is worse at 1600. Both policies use released-arm playback, so this early comparison does not isolate a Stage 1 training effect. The 10001/50000 evaluations remain pending. DeepWBC, MLM, further robots, real hardware, ROS 2 and VLA remain later work. KISS My Agent supports development and is not a runtime dependency.

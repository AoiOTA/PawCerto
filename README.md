...
Start with the [researcher guide](docs/researcher-guide.md) for the implemented workflow and extension points. For the second method, see [RoboDuet training and export](docs/roboduet-training.md), [task semantics](docs/roboduet-task.md), and [runtime evidence](docs/roboduet-runtime.md). See the [research preview and policy videos](docs/release-evidence.md) for downloadable results and their evaluation scope.

...
Only UMI-on-Legs is under implementation. RoboDuet, DeepWBC, MLM, other robots, real hardware, ROS 2 and VLA are outside this phase. KISS My Agent supports development and is not a runtime dependency.

...
class ActorCritic(nn.Module):
    ...
    def __init__(self, num_obs,
        ...
        AC_Args = config if config is not None else globals()["AC_Args"]
        ...
        self.adaptation_weights = list(AC_Args.adaptation_weights)
        ...
        # Upstream assigns a bool over a torch API; omit that global mutation.

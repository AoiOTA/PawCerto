# Adapted from b1_gym/rewards/b1_loco_z1_gaitfree_rewards.py at c760e1d74ad165d3c069d4f57ab5d066f6a41eb6.
# Copyright (c) 2022 MIT Improbable AI Lab. See ../LICENSE and ../LICENSES.
import torch
import numpy as np
...
class B1LocoZ1GaitfreeRewards:
    ...
    def _reward_manip_pos_tracking(self):
        ...
        ee_idx = self.env.ee_measurement_index

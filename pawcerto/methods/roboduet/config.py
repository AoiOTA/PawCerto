"""Effective default Go1 auto_train configuration at the fixed RoboDuet revision.

Source order: automatic/legged_robot_config.py, go1_config.py, wtw_config.py,
asset_config.py, then scripts/auto_train.py (no resume/debug/rot6d).
This is a JSON-compatible snapshot plus the named torso-mass correction below;
no simulator or params-proto import is needed.
Original values and source licensing: RoboDuet MIT and legged_gym BSD-3-Clause.
"""
from copy import deepcopy

SOURCE_REVISION = "a7e1528215c048199f90cb69ceb7749a1d745f28"

_DEFAULT = {'Cfg': {'hybrid': {'num_actions': 18,
                    'plan_vel': False,
                    'use_vision': False,
                    'rewards': {'terminal_body_height': 0.28,
                                'use_terminal_body_height': True,
                                'use_terminal_roll': False,
                                'use_terminal_pitch': True,
                                'use_terminal_roll_pitch': False,
                                'terminal_body_roll': 0.1,
                                'terminal_body_pitch': 0.2,
                                'terminal_body_pitch_roll': 1.3962634015954636,
                                'headupdown_thres': 0.1},
                    'reward_scales': {'jump': -0.0,
                                      ...
                                      'arm_energy': -4e-05,
                                      'arm_dof_vel': -0.001,
                                      'arm_dof_acc': -2.4999999999999998e-06,
                                      'arm_action_rate': -0.1,
         ...
         'arm': {'num_actions_arm': 6,
                 ...
                 'arm_num_obs_history': 600,
                 'arm_num_commands': 6,
                 'num_actions_arm_cd': 8,
                 'commands': {'angle75': 1.3089969158172607,
                              'angle60': 1.0471975803375244,
                              'l': [0.3, 0.77],
                              'p': [-1.413716694115407, 1.413716694115407],
                              'y': [-1.5707963267948966, 1.5707963267948966],
                              'roll_ee': [-1.413716694115407, 1.413716694115407],
                              'pitch_ee': [-1.0471975803375244, 1.0471975803375244],
                              'yaw_ee': [-1.3089969158172607, 1.3089969158172607],
                              'T_traj': [2, 3.0],
                              'T_force_range': [1, 4.0],
                              'add_force_thres': 0.3},
                 'obs_scales': {'l': 1.0, 'p': 1.0, 'y': 1.0, 'wx': 1.0, 'wy': 1.0, 'wz': 1.0},
                 'control': {'stiffness_arm': {'zarx': 50,
                                               'zarx_j1': 40,
                                               'zarx_j2': 70,
                                               'zarx_j3': 70,
                                               'zarx_j4': 25,
         ...
         'dog': {'num_actions_loco': 12,
                 ...
                 'dog_num_obs_history': 1680,
                 'dog_num_commands': 5,
                 'dog_actions': 12,
                 'control': {'stiffness_leg': {'joint': 35.0}, 'damping_leg': {'joint': 1.0}}},
         'env': {'num_envs': 2048,
                 'num_observations': 63,
                 ...
                 'keep_arm_fixed': True,
                 'priv_observe_vel': False,
                 'priv_observe_high_freq_goal': False},
         ...
         'control': {'control_type': 'M',
                     'stiffness': {'joint': 35.0, 'widow': 5.0, 'zarx': 5.0, 'zarx_j3': 20},
                     'damping': {'joint': 1.0},
                     'action_scale': 0.25,
                     'hip_scale_reduction': 0.5,
                     'decimation': 4,
                     'update_obs_freq': 20},
         'asset': {'file': '{MINI_GYM_ROOT_DIR}/resources/robots/arx5p2Go1/urdf/arx5p2Go1.urdf',
                   'foot_name': 'foot',
         ...
         'domain_rand': {'rand_interval_s': 4,
                         ...
                         # PawCerto fix: source body 0 is a 0.440377 kg mount,
                         # so [-2, 2] could create non-positive mass/inertia.
                         'base_mass_body': 'trunk',
                         ...
                         'randomize_end_effector_force': False,
                         'max_force': 15,
                         'max_force_offset': 0.01},
         ...
         'use_rot6d': False},
 'DogAC_Args': {'init_noise_std': 1.0,
                'actor_hidden_dims': [512, 256, 128],
                'critic_hidden_dims': [512, 256, 128],
                'activation': 'elu',
                'adaptation_module_branch_hidden_dims': [256, 128],
                'use_decoder': False},
 'ArmAC_Args': {'init_noise_std': 0.1,
                'actor_hidden_dims': [512, 256, 128],
                'critic_hidden_dims': [512, 256, 128],
                'activation': 'elu',
                'adaptation_module_branch_hidden_dims': [256, 128],
                'use_decoder': False},
 'PPO_Args': {'value_loss_coef': 1.0,
              ...
              'adaptation_module_learning_rate': 0.0005,
 ...
 'RunnerArgs': {'algorithm_class_name': 'PPO',
                ...
                'checkpoint': -1},
 'source_revision': 'a7e1528215c048199f90cb69ceb7749a1d745f28',
 'stage': {'pretrained_to_hybrid_start': 10000, 'pretrained_to_hybrid_end': 10000}}


def default_config():
    """Return independent editable defaults; budgets are source values, not authorization."""
